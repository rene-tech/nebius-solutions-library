locals {
  ...
  foundation_variables = {
    ...
    pod_security_rollout_receipt = {
      ...
      custody_owner_kubeconfig_path = var.deployment.pod_security.receipt.custody_owner_kubeconfig_path
      custody_owner_context         = var.deployment.pod_security.receipt.custody_owner_context
