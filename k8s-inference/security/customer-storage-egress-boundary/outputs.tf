output "current_handoff" {
  ...
  value = {
    schema                        = "fs2-serve.nebius.ai/customer-storage-egress-security-handoff/v3"
    ...
    workload_policy_name          = local.workload_policy_names[var.current_workload_policy_generation]
