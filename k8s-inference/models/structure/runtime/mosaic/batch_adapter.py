...
RECIPE_SHA256 = "23fe53814b9946d482d42d5e0b177a482797273614493e520479324317c5aac5"
BOLTZ2_ARTIFACT_MANIFEST_SHA256 = (
    "6e83771034762feae697f9b2a0780f0ced57649b2a9d6fa5562786eceafc5e9e"
)
    ...
    pod_spec = {
        ...
        "containers": [{
            ...
            "volumeMounts": [
                ...
                {"name": "mosaic-checkpoints", "mountPath": "/opt/fs2/artifacts/mosaic", "readOnly": True},
            ],
        }],
        "volumes": [
            ...
            {"name": "mosaic-checkpoints", "artifactMaterialization": {"artifact_id": "mosaic-boltz2-checkpoints", "access": "restricted-readonly"}},
        ],
    }
    return {
        "apiVersion": "batch/v1",
