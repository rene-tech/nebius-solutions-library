...
| AMBER H100 independently mass-weighted saved current velocities | 300.178 | 0.159 | 299.845–300.511 |
| AMBER L40S native reported, sensitivity control | **297.627** | 0.142 | **297.330–297.924** |
| AMBER L40S saved current velocities, sensitivity control | 299.486 | 0.138 | 299.196–299.775 |
...
L40S still has a 0.514 K deficit in the saved-velocity observable; its first and
second half means are 299.763 and 299.209 K. H100's corresponding means are
300.111 and 300.244 K. This finite-run sensitivity is retained, not declared
...
commit `2b3944d7363b86312206367ca788a120b6d933c6`. The actual CUDA PME kernel
...
does not remove three COM DOF. The diagnostic uses the native Fortran constant
`KB = 1.380658e-23 × 6.0221367e23 / 4184 = 0.00198721587284 kcal/(mol K)`.
The CUDA thermostat's closely differing `0.00831441/4.184` constant is recorded
in the source note; it does not explain the 1.85 K discrepancy. NetCDF's declared
...
An explicitly different COM-removed estimator using 13,203 DOF gives 300.179505 K
for H100 and 299.486831 K for L40S, changes of only about 0.001–0.002 K. COM
...
| AMBER H100 saved current velocities | 507.6 | 0.169 | 299.834–300.521 |
| AMBER L40S native | 634.5 | 0.149 | 297.316–297.939 |
| AMBER L40S saved current velocities | 636.4 | 0.150 | 299.187–299.784 |
...
Actual receipt:
`/home/tux/fs2-alanine-analysis-20260923/temperature-diagnostic-02.json`.
...
diagnostic01 is retained. No new MD steps were generated for this analysis.
