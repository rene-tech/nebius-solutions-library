  ...
  validation {
    condition = try(
      alltrue([
        ...
        var.deployment.models.runtime_security_authorizations[compatibility.authorization_id].subject_schema == "fs2-serve.nebius.ai/runtime-security-compatibility/v4" &&
