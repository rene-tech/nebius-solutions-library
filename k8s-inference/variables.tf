variable "deployment" {
  ...
  type = object({
    ...
    pod_security = optional(object({
      ...
      receipt = optional(object({
        ...
        custody_owner_kubeconfig_path = optional(string)
        custody_owner_context         = optional(string)
        custody_owner_username        = optional(string)
  ...
  validation {
    condition = (
      ...
      alltrue([
        for namespace in var.deployment.pod_security.existing_scientific_namespaces :
