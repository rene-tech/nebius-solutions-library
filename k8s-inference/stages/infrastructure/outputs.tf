...
output "operator_handoff_contract" {
  ...
  value = {
    service_account_id = nonsensitive(local.active_operator_handoff_service_account_id)
    group_id           = nonsensitive(local.active_operator_handoff_group_id)
    lineage_id         = nonsensitive(local.operator_handoff_lineage_id)
    generation         = var.operator_handoff_generation
    role               = "viewer"
...
output "owned_resource_ids" {
  ...
  value = {
    ...
    operator_handoff_sa             = local.active_operator_handoff_service_account_id
    operator_handoff_viewer_group   = local.active_operator_handoff_group_id
