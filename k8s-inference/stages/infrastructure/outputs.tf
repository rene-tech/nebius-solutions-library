...
output "public_edge_availability_contract" {
  ...
  value       = local.public_edge_availability_contract
}

output "public_edge_availability_contract_sha256" {
  description = "Canonical digest of public_edge_availability_contract for direct downstream state binding."
  value       = sha256(jsonencode(local.public_edge_availability_contract))
}
