...
resource "helm_release" "control_plane" {
  ...
  depends_on = [
    ...
    kubernetes_deployment_v1.scientific_artifact_broker,
    kubernetes_service_v1.scientific_artifact_broker,
    kubernetes_deployment_v1.scientific_artifact_authority,
    kubernetes_service_v1.scientific_artifact_authority,
    kubernetes_manifest.scientific_artifact_broker_network_policy,
    kubernetes_manifest.scientific_artifact_authority_network_policy,
