...
locals {
  # Optional v3 delivery fields must not change the hash of a cached v2
  # contract during destroy. Strip their coerced null/default values for that
  # compatibility lane; new contracts hash the complete canonical object.
