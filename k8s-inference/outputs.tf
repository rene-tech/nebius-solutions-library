...
output "effective_configuration" {
  ...
  value = {
    ...
    postgresql_backup = {
      ...
      database_volume_gib        = local.postgresql_database_volume_size_gib
      ...
      wal_archiving              = true
      marker_preparation         = var.deployment.acceptance.prepare_database_restore_marker
      restore_verification       = var.deployment.acceptance.verify_database_restore
      marker_cleanup             = var.deployment.acceptance.cleanup_database_restore_marker
      restore_source_cluster_uid = var.deployment.acceptance.database_restore_source_cluster_uid
      restore_source_backup      = var.deployment.acceptance.database_restore_source_backup_name
      restore_source_backup_uid  = var.deployment.acceptance.database_restore_source_backup_uid
      restore_source_backup_wal  = var.deployment.acceptance.database_restore_source_backup_wal
      restore_verified_wal       = var.deployment.acceptance.database_restore_verified_wal
      restore_target_time        = var.deployment.acceptance.database_restore_target_time
