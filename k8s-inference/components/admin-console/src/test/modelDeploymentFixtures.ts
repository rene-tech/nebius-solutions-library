...
export const modelDeploymentSpecFixture: ModelDeploymentSpec = {
  ...
  fastStart: { mode: "Fixed", level: "L3", fallbackPolicy: "AllowLowerLevel" },
  ...
  observation: {
    ...
    status: {
      ...
      fastStart: {
        ...
        qualifiedLevel: "L2",
        state: "Fallback",
        reason: "The requested L3 path is not qualified on this accelerator; using qualified L2.",
        targetSeconds: 120,
        ...
        mechanisms: { image_cache: "regional", snapshot: "shared-filesystem", residency: "none" },
      },
