...
const fixtureKey = {
  ...
  admission_budget_consumed_gpu_seconds: 8741,
  admission_budget_reserved_gpu_seconds: 8,
  max_concurrency: 8,
  ...
  usage: {
    ...
    conservative_attempted_gpu_seconds: accessMeasurement(8741, "gpu-seconds", "estimated", "Conservative admission estimate; not measured usage"),
