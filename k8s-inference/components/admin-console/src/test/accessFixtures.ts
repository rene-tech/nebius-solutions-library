...
export const testKey: AdminApiKey = {
  ...
  admission_budget_consumed_gpu_seconds: 5,
  admission_budget_reserved_gpu_seconds: 1,
  max_concurrency: 2,
  ...
  usage: {
    ...
    conservative_attempted_gpu_seconds: { value: 5, unit: "gpu-seconds", state: "estimated", reason: "Conservative admission estimate; not measured usage" },
