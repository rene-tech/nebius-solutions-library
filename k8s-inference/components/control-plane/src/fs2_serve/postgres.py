                ...
                if applied == expected:
                    async with pool.acquire() as connection:
                        runtime_privileges_ready = await connection.fetchval(
                            ...
                            "'public.fs2_consume_session_exchange_exact_v2(text,integer,integer,integer)','EXECUTE')"
                            " AND NOT has_function_privilege(current_user,"
                            "'public.fs2_consume_session_exchange_exact_v2(text,integer,integer,integer)','EXECUTE')"
                            " AND NOT has_function_privilege('fs2_serve_runtime',"
                            "'public.fs2_consume_session_exchange_bridge(text,integer,integer,integer)','EXECUTE')"
                            " AND NOT has_function_privilege(current_user,"
                            "'public.fs2_consume_session_exchange_bridge(text,integer,integer,integer)','EXECUTE')"
