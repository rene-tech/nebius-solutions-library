...
async def reconcile_user_storage(settings: Settings) -> None:
    ...
    service = UserStorageService(
        ...
        activation_fence=StorageReconcilerActivationFence(
            ...
            receipt_authority_registry_file=settings.user_storage_activation_receipt_authority_registry_file,
            receipt_authority_registry_sha256=settings.user_storage_activation_receipt_authority_registry_sha256,
...
def main() -> None:
    # Preserve callers of python -m fs2_serve.cli as well as the lightweight
    # console entrypoint. All companion argument handling lives in one place.
