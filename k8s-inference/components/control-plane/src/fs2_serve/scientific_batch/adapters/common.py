...
_RECIPE_MODEL_PATHS = {
    "alphafold3": (
        ...
        "models/cancer-immunotherapy/images/alphafold3/contracts/af3-image-lock.json",
        "models/cancer-immunotherapy/images/alphafold3/contracts/af3-parameter-binding.json",
        ...
        "models/cancer-immunotherapy/images/alphafold3/contracts/af3-runtime-source-lock.json",
        "models/cancer-immunotherapy/images/alphafold3/runtime/af3_runtime.py",
    ),
    "boltzgen": (
    ...
    "esmfold2": (
        ...
        "models/cancer-immunotherapy/images/structure-secondary/result_contract.py",
        "models/cancer-immunotherapy/images/structure-secondary/run_esmfold2.py",
        "models/cancer-immunotherapy/images/structure-secondary/runtime_localization.py",
    ),
    "esmfold2-fast": (
    ...
    "openfold3-openbind": (
        ...
        "models/cancer-immunotherapy/images/structure-secondary/image-lock.json",
        "models/cancer-immunotherapy/images/structure-secondary/openfold3-runner-base.yaml",
        "models/cancer-immunotherapy/images/structure-secondary/result_contract.py",
        "models/cancer-immunotherapy/images/structure-secondary/run_openfold3.py",
        "models/cancer-immunotherapy/images/structure-secondary/runtime_localization.py",
    ),
    "protenix-v2": (
        ...
        "models/cancer-immunotherapy/images/structure-secondary/image-lock.json",
        "models/cancer-immunotherapy/images/structure-secondary/result_contract.py",
        "models/cancer-immunotherapy/images/structure-secondary/run_protenix.py",
        "models/cancer-immunotherapy/images/structure-secondary/runtime_localization.py",
    ),
    "rfdiffusion": (
