...
class Settings(BaseSettings):
    ...
    scientific_batch_controller_service_account_namespace: str = Field(
        default="fs2-system",
        min_length=1,
        max_length=63,
        pattern=r"^[a-z0-9](?:[-a-z0-9]{0,61}[a-z0-9])?$",
    )
    scientific_batch_controller_service_account_name: str = Field(
        default="fs2-serve-control-plane-runtime",
        min_length=1,
        max_length=63,
        pattern=r"^[a-z0-9](?:[-a-z0-9]{0,61}[a-z0-9])?$",
    )
