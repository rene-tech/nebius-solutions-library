...
def test_default_migration_path_resolves_the_source_tree_and_runtime_has_no_ddl() -> None:
    ...
    assert migration_names == [
        ...
        "0032_scientific_admission_completion.sql",
...
def test_clean_wheel_imports_catalog_without_repository_pythonpath(tmp_path: Path) -> None:
    ...
    with zipfile.ZipFile(wheels[0]) as wheel_archive:
        ...
        assert migration_names == [
            ...
            "fs2_serve/migrations/0030_scientific_retention_authority.sql",
            "fs2_serve/migrations/0031_retention_scan_hardening.sql",
            "fs2_serve/migrations/0032_scientific_admission_completion.sql",
            "fs2_serve/migrations/0033_retention_privilege_and_token_scan.sql",
