...
def test_default_migration_path_resolves_the_source_tree_and_runtime_has_no_ddl() -> None:
    ...
    assert receipt["migration_count"] == 36
    assert receipt["last_migration_version"] == "0035_storage_reconciler_drain.sql"
...
def test_clean_wheel_imports_catalog_without_repository_pythonpath(tmp_path: Path) -> None:
    ...
    with zipfile.ZipFile(wheels[0]) as wheel_archive:
        ...
        assert migration_names == [
            ...
            "fs2_serve/migrations/0022_scientific_admission_outbox_lock_privilege.sql",
            "fs2_serve/migrations/0023_scientific_batch_scheduling_digest_privilege.sql",
            "fs2_serve/migrations/0024_scientific_model_policies.sql",
            "fs2_serve/migrations/0025_scientific_startup_policies.sql",
            "fs2_serve/migrations/0026_apps.sql",
            ...
            "fs2_serve/migrations/0030_customer_storage_credentials.sql",
            ...
            "fs2_serve/migrations/0034_storage_provider_tenant_guards.sql",
            "fs2_serve/migrations/0035_storage_reconciler_drain.sql",
        ]
    ...
    subprocess.run(  # noqa: S603 - interpreter and code are fixed by this test.
        [
            ...
            (
                ...
                "assert len(list(migration_dir.glob('[0-9][0-9][0-9][0-9]_*.sql'))) == 34;"
