...
This directory contains a deployable client contract for using Nebius Scientific
AI Apps from LibreChat:
...
The canonical MCP connection ID is `scientific-ai-apps`. The naming and legacy
compatibility boundary is documented in
[Scientific AI naming](../../docs/SCIENTIFIC_AI_NAMING.md).
