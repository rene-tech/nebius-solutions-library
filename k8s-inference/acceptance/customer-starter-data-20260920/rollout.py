...
starter-pack configuration. Does not provision or resize any model/node.
"""
...
def main(args):
    ...
    candidate["customerStorage"]["starterPack"] = {
        "enabled": bool(args.pack_image),
        "image": args.pack_image or "",
        "manifestSha256": args.manifest_sha256 or "",
...
if __name__ == "__main__":
    ...
    parser.add_argument("--pack-image")
